...
namespace NIBM.Procurement.common.db.migrations
{
    ...
    [Migration("20210823064632_test7")]
    partial class test7
    {
            ...
            modelBuilder.Entity("NIBM.Procurement.DB.Entities.ProcuremenetRequest", b =>
                {
                    ...
                    b.Property<int?>("ReqNowithin3Months")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AwardedVendorId")
                        ...
                        .HasFilter("[AwardedVendorId] IS NOT NULL");
            ...
            modelBuilder.Entity("NIBM.Procurement.DB.Entities.ProcuremenetRequest", b =>
                {
                    b.HasOne("NIBM.Procurement.DB.Entities.Vendor", "Vendor")
                        .WithOne("ProcuremenetRequest")
                        .HasForeignKey("NIBM.Procurement.DB.Entities.ProcuremenetRequest", "AwardedVendorId")
                        .HasConstraintName("FK_ProcuremenetRequest_AwardedVendor");
