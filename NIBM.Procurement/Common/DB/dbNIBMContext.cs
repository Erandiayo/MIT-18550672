    ...
    public partial class dbNIBMContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Menu>().HasData(
                new Menu { MenuID = 1, ParentMenuID = null, DisplaySeq = 10, Text = "Branches", Type = "I", Area = "Admin", Controller = "Branches", Action = "Index" },
                new Menu { MenuID = 2, ParentMenuID = null, DisplaySeq = 20, Text = "Departments", Type = "I", Area = "Admin", Controller = "Departments", Action = "Index" },
                new Menu { MenuID = 3, ParentMenuID = null, DisplaySeq = 30, Text = "Branch Departments", Type = "I", Area = "Admin", Controller = "BranchDepartments", Action = "Index" },
                new Menu { MenuID = 4, ParentMenuID = null, DisplaySeq = 40, Text = "Sub Departments", Type = "I", Area = "Admin", Controller = "SubDepartment", Action = "Index" },
                new Menu { MenuID = 5, ParentMenuID = null, DisplaySeq = 50, Text = "Designations", Type = "I", Area = "Admin", Controller = "Designations", Action = "Index" },
                new Menu { MenuID = 6, ParentMenuID = null, DisplaySeq = 60, Text = "Employees", Type = "I", Area = "Admin", Controller = "Employees", Action = "Index" },
                new Menu { MenuID = 7, ParentMenuID = null, DisplaySeq = 70, Text = "User Roles", Type = "I", Area = "Admin", Controller = "UserRoles", Action = "Index" },
                new Menu { MenuID = 8, ParentMenuID = null, DisplaySeq = 80, Text = "Users", Type = "I", Area = "Admin", Controller = "Users", Action = "Index" },
                new Menu { MenuID = 9, ParentMenuID = null, DisplaySeq = 90, Text = "Procurement Request", Type = "I", Area = "Procurement", Controller = "ProcurementRequests", Action = "Index" },
                new Menu { MenuID = 10, ParentMenuID = null, DisplaySeq = 100, Text = "Approve Requests", Type = "I", Area = "Procurement", Controller = "ProcurementRequests", Action = "Requests" },
                new Menu { MenuID = 11, ParentMenuID = null, DisplaySeq = 110, Text = "Procurement Department Process", Type = "I", Area = "Procurement", Controller = "ProcurementRequests", Action = "Requests" },
                new Menu { MenuID = 12, ParentMenuID = null, DisplaySeq = 120, Text = "Procurement Request Summary", Type = "I", Area = "Procurement", Controller = "Reports", Action = "ProcurementRequestSummaryReport" });
        }
